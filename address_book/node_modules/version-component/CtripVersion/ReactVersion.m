...
//                rejecter([NSError errorWithDomain:ErrorDomain code:(500) userInfo:@{NSLocalizedDescriptionKey: [NSString stringWithFormat:@"Can not get JS Version"]}]);
        ...
        @catch (NSException *exception) {
            rejecter(@"500", @"Can not get JS Version", [NSError errorWithDomain:ErrorDomain code:(500) userInfo:@{NSLocalizedDescriptionKey: exception.reason}]);
...
//                    rejecter(error);
                    rejecter(@"", [NSString stringWithFormat:@"Download error. %@", [error description]], error);
                    return;
                }
...
//                    rejecter(ioError);
            ...
            rejecter(@"500", @"don't need update", [NSError errorWithDomain:ErrorDomain code:(500) userInfo:@{NSLocalizedDescriptionKey: [NSString stringWithFormat:@"don't need update"]}]);
                  ...
                  rejecter:(RCTPromiseRejectBlock)rejecter)
{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:path]) {
        rejecter(@"500", @"no file exists", [NSError errorWithDomain:ErrorDomain code:(500) userInfo:@{NSLocalizedDescriptionKey: [NSString stringWithFormat:@"no file exists"]}]);
